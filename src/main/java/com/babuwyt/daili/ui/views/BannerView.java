...
import com.babuwyt.daili.adapter.BannerAdapter;
...
//                mViewPager.getCurrentItem();
        ...
        if (viewList != null && viewList.size() != 0) {
            if (mLinearPosition.getChildCount() != viewSize) {
                ...
                for (int i = 0; i < diffCnt; i++) {
                    if (needAdd) {
                        ...
                        img.setBackgroundResource(R.drawable.point_blue);
            ...
            for (int i = 0; i < mLinearPosition.getChildCount(); i++) {
                if (i == (curPos % viewSize)) {
                    ...
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.point_gray_line);
                }
            }
        }
    }
    ...
    public interface ChangeLister{
        void onChangeLister(int position);
    }
    private ChangeLister lister;
    public void addChangeLister(ChangeLister lister){
        this.lister=lister;
    }
    @Override
